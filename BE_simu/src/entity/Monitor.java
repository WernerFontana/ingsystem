...
public class Monitor {
	...
	public static void main(String [] args) throws IOException, WriteException {
		...
		System.out.println("Durï¿½e de simulation : "+Duration.between(debut, LocalDateTime.now()));*/
		...
		WritableSheet freqC = fic.createSheet("FrÃ©quentation des croisements", 1);
		WritableSheet freqL = fic.createSheet("FrÃ©quentation des voies", 2);
